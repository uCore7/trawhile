...
- UR-00-C19: Request rates shall be limited on every routed external endpoint reachable from outside the deployed instance, to prevent abuse and brute-force attacks. [Rationale: G-5; OWASP]
