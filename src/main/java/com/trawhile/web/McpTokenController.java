...
/**
 * /api/v1/admin/mcp-tokens — System Admin view and revocation of all MCP tokens. SR-067/SR-068.
 *
 * Own-token endpoints (GET/POST/DELETE /api/v1/account/mcp-tokens) are in AccountController.
 *
 * Endpoints:
 *   GET    /admin/mcp-tokens          — SR-067  listAllMcpTokens (System Admin)
 *   DELETE /admin/mcp-tokens/{id}     — SR-068  adminRevokeMcpToken (System Admin; logs to security_events)
 */
@RestController
