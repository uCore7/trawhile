...
| TE-00-C19.F01-01 | SR-00-C19.F01 | UR-00-C19 | IT | `MetricsIT` | `/actuator/prometheus` is reachable on the management port and includes the project's custom metric series |
